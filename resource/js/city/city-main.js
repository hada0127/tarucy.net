...
function isWindowLikeColor(r, g, b) {
  ...
  // 핑크/마젠타 계열 (city-colors.js 기준)
  // 0xff6090 (255,96,144), 0xff5080 (255,80,128), 0xe06088 (224,96,136)
  // 0xff7098 (255,112,152), 0xf05078 (240,80,120), 0xe85090 (232,80,144)
  // R > 200, G: 60~130, B: 100~170
  const isPink = r > 200 && g >= 60 && g <= 130 && b >= 100 && b <= 170;

  // 시안 계열 (city-colors.js 기준)
  // 0x50d0e0 (80,208,224), 0x60c8d8 (96,200,216), 0x70e0f0 (112,224,240)
  // R: 60~130, G > 180, B > 200
  const isCyan = r >= 60 && r <= 130 && g > 180 && b > 200;
